const fs = require('fs');
const content = `package com.next2me.next2view.repository;
...
`;
fs.writeFileSync('backend/src/main/java/com/next2me/next2view/repository/ActivityDismissalRepository.java', content, 'utf8');
console.log('DONE: ActivityDismissalRepository rewritten clean');