...
const migration = `-- V19: Security Documents Module
...
fs.writeFileSync('backend/src/main/resources/db/migration/V19__security_documents.sql', migration, 'utf8');
console.log('✅ V19 migration created');
