      ...
      <div class="modal">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea v-model="form.contractDesc" placeholder="Περιγραφή project..." class="form-input" rows="3"></textarea>
          </div>
          <div v-if="formError" class="form-error">{{ formError }}</div>
        </div>
        <div class="modal-footer">
          <button class="btn-cancel" @click="showNewProject = false">Ακύρωση</button>
