  ...
  <div class="content">
    ...
    <div v-if="activeTab==='activity'" class="activity-section">
      ...
      <div v-else class="notif-list">
        <div v-for="a in activityLog" :key="a.id" class="notif-card info activity-card" @click="a.projectId ? router.push('/projects/' + a.projectId) : (a.entityType === 'PROJECT' && a.entityId && router.push('/projects/' + a.entityId))" :style="{cursor: (a.projectId || a.entityType === 'PROJECT') ? 'pointer' : 'default'}">
